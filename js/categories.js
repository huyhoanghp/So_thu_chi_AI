...
window.renderSettingsCategories = function() {
    ...
    if (settingsIncomeCategories) {
        ...
        window.categories.income.forEach(cat => {
            ...
            div.className = 'flex items-center justify-between p-2.5 bg-slate-50 dark:bg-slate-800 rounded-xl border border-gray-150 dark:border-slate-700/60 text-sm';
            div.innerHTML = `
