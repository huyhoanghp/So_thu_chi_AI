...
window.handleProductFormSubmit = async function(e) {
    ...
    const saveProduct = async () => {
        ...
        try {
            ...
            // Trigger low stock warning if the newly saved/updated stock level is below threshold
            if (typeof window.sendTelegramProductStockAlert === 'function') {
                window.sendTelegramProductStockAlert(data.name, data.stock);
            }
        } catch (err) { 
